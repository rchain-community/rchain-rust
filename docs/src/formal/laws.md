...
> disagree, the register is right. Its total is **<!-- counts:proved-laws -->41<!-- counts:end --> of
> <!-- counts:laws -->49 laws<!-- counts:end --> proved at all — <!-- counts:proved-tied-laws -->13<!-- counts:end --> tied to the node by a corpus,
