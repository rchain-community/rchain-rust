...
> Its total is **<!-- counts:proved-laws -->35<!-- counts:end --> of <!-- counts:laws -->49 laws<!-- counts:end --> proved at all — <!-- counts:proved-tied-laws -->8<!-- counts:end --> tied to the node by a corpus, <!-- counts:proved-model-laws -->27<!-- counts:end --> over
