...
> concurrently, what must serialize, and *why*, founded in the 29 laws. It is the target the Lean
...
> any layer — must reach the same canonical state as the purely-sequential execution. The 29 laws make
...
> **Formal.** The full catalog is 48 rows — [The 29 laws](the-29-laws.md) for the calculus,
