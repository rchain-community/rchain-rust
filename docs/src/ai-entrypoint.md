...
([`spec/INVENTORY.md`](../../spec/INVENTORY.md), **48 rows**: the 29 calculus laws, 14 covering the
surface a client writes, 4 for the Proof-of-Stake epoch, and one for the fee consequence of a denied
deploy), the ρ-calculus core
...
RChain's behavior is pinned by **48 laws** ([`spec/INVENTORY.md`](../../spec/INVENTORY.md)): the 29
...
([Laws 44–47](formal/laws-44-47.md)), and row 48 about the fee consequence of a denied deploy — a
rule neither tree implements, recorded as an open design question. The first 29 group as:
...
| `spec/INVENTORY.md` | the 48-row law catalog with source-of-truth + status | — |
