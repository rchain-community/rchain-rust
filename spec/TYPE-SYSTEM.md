...
(`.github/workflows/ci.yml:29-68` — the declaration and its thirty-nine `-A` items; CI's own invocation is
`:90`), and the fields of a configuration surface are typically `pub` in the
